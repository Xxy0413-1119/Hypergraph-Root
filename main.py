...
parser.add_argument('--mode', default="out", type=str)     # cross-validation or independent test
parser.add_argument('--run', default= 1, type=str)          # run times
args = parser.parse_args()

out_test = "out_test"
positive = "positive_example.csv"          # modify if you want to use different dataset
negative = "negative_example.csv"
...
def train_and_test(df):
    ...
    os.system('copy /y .\independent_testset\\test_label .\out_test')       # remember to change your path
    os.system('copy /y .\independent_testset\\test_fasta .\out_test')
